    ...
    <nav className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            <Link to="/about" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100">About</Link>
            <Link to="/ngos" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100">NGOs</Link>
      ...
      <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <Link to="/ngos" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100">NGOs</Link>
